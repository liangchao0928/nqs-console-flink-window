...
public class ClickhouseSink extends RichSinkFunction<GwData> implements Serializable {
...
//    private List<GwData> list = new ArrayList<>();
...
//
//    // 插入数据
//    public void insertData(List<GwData> rows, PreparedStatement preparedStatement, Connection connection) throws SQLException {
//
//        for (int i = 0; i < rows.size(); ++i) {
//            GwData row = rows.get(i);
...
//    }
//
//    public void invoke(GwData row, Context context) throws Exception {
//
